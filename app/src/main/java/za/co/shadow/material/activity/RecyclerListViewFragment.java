...
import za.co.shadow.material.adapter.MyExpandableDraggableSwipeableItemAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        myItemAdapter.setEventListener(new MyExpandableDraggableSwipeableItemAdapter.EventListener() {
            ...
            public void onGroupItemRemoved(int groupPosition) {
                ((EmergencyFragment) getEmergencyFragment()).onGroupItemRemoved(groupPosition);
            }

            @Override
            public void onChildItemRemoved(int groupPosition, int childPosition) {
                ((EmergencyFragment) getEmergencyFragment()).onChildItemRemoved(groupPosition, childPosition);
            }

            @Override
            public void onGroupItemPinned(int groupPosition) {
                ((EmergencyFragment) getEmergencyFragment()).onGroupItemPinned(groupPosition);
            }

            @Override
            public void onChildItemPinned(int groupPosition, int childPosition) {
                ((EmergencyFragment) getEmergencyFragment()).onChildItemPinned(groupPosition, childPosition);
            }
            ...
            @Override
            public void onMessageFocusChanged(View v) {
                onMessageFocusChange(v);}
        });
...
//        mRecyclerView.addItemDecoration(new SimpleListDividerDecorator(ContextCompat.getDrawable(getContext(), R.drawable.list_divider_h), true));
    ...
    private void onMessageFocusChange(View v) {
        TextView mMessage = (TextView) (v);
        getDataProvider().getMessageItem(0).setMessage(mMessage.getText().toString());
    ...
    private void onItemViewClick(View v, boolean pinned) {
        ...
        if (childPosition == RecyclerView.NO_POSITION) {
            ((EmergencyFragment) getEmergencyFragment()).onGroupItemClicked(groupPosition);
        } else {
            ((EmergencyFragment) getEmergencyFragment()).onChildItemClicked(groupPosition, childPosition);
        }
    }
    ...
    public AbstractMessageDataProvider getDataProvider() {
        return ((EmergencyFragment) getEmergencyFragment()).getDataProvider();
    }
    ...
    public void notifyDataSetChanged(int newItem)
    {
        mAdapter.notifyDataSetChanged();
    ...
    public Fragment getEmergencyFragment() {
        return getActivity().getSupportFragmentManager().findFragmentByTag(constants.TAG_EMERGENCY_FRAGMENT);
    }
}
