...
public class BluetoothHandler {
    ...
    private UUID targetServiceUuid = UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb");
    private UUID targetCharacterUuid = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
    private UUID readUUID = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");

    private UUID KEY_BATTERY_LEVEL = UUID.fromString("00002a19-0000-1000-8000-00805f9b34fb");
    private UUID BATTERY_SERVICE = UUID.fromString("0000180f-0000-1000-8000-00805f9b34fb");

    private BluetoothGattCharacteristic targetGattCharacteristic = null;

    private Context context;

    private BluetoothGattService targetGatBatteryService = null;
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Toast.makeText(context, "battery level=" + Integer.toString(batteryLevel), Toast.LENGTH_SHORT).show();
    ...
    public void getCharacteristic(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            if (uuid.equals(BATTERY_SERVICE.toString())) {
                ...
                BluetoothGattCharacteristic readGattCharacteristic = targetGatBatteryService.getCharacteristic(KEY_BATTERY_LEVEL);
