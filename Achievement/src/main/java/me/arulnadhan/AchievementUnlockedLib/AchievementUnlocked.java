...
public class AchievementUnlocked {
    ...
    private int sizeLarge = 70;
    private int sizeSmall = 50;
    public int height;
    public int width;
    ...
    public AchievementUnlocked setHeight(int _height) {
        this.sizeLarge = _height;
        return this;
    }
    ...
    private void buildAchievement() {
        ...
        if (large)
            initialSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, sizeLarge, context.getResources().getDisplayMetrics());
        else
            initialSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, sizeSmall, context.getResources().getDisplayMetrics());
        ...
        subtitleText.setSingleLine(false);
        ...
        subtitleText.setHorizontallyScrolling(false);
